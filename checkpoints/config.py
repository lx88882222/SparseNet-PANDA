custom_imports = dict(
    ...
    imports=[
        'mmdet.models.backbones.sparsenet_lsconv',
    ])
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='coco_json/val_s4.json',
        data_prefix=dict(img='patches/s4/'),
        data_root='/data1/lixiang/PANDA/PANDA/',
        metainfo=dict(classes=('person', )),
        pipeline=[
            dict(
                file_client_args=dict(backend='disk'),
...
work_dir = './work_dirs/2222dino-4scale_sparsenet_lsconv_custom_0.1topk'
